...
int PSS_GetCredit(char const* section, char const* name, std::string& strErr) {
	...
	case 1:
		strErr = "send login account failed, please retry later";
		break;
	case 2:
		strErr = "can't connect account server, please retry later";
		break;

	case -1:
		strErr = "System is error! please retry later";
		break;
	case -2:
		strErr = "can't connect bill system! please retry later";
		break;
	case -3:
		strErr = "un activation subarea";
		break;
	case -4:
		strErr = "point is't enough , please bug point first!";
		break;
	default:
		strErr = "query failed, please retry later";
		break;
