...
#define CMD_CM_INVSORT CMD_CM_ROLEBASE + 50				// 结束读书
#define CMD_CM_REQUESTBAGOFHOLDING CMD_CM_ROLEBASE + 51 // 结束读书
...
#define CMD_CP_SAY2VIP CMD_CP_BASE + 412
#define CMD_CP_SAY2DIS CMD_CP_BASE + 413
