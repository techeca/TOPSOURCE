...
const char* g_GetAreaName(int nValue) {
	switch (nValue) {
	case 1:
		return RES_STRING(CO_COMMFUNC_CPP_00024); //"陆地/海洋";
	case 2:
		return RES_STRING(CO_COMMFUNC_CPP_00025); //"非战斗区";
	case 3:
		return RES_STRING(CO_COMMFUNC_CPP_00026); //"非PK区";
	case 4:
		return RES_STRING(CO_COMMFUNC_CPP_00027); //"桥";
	case 5:
		return RES_STRING(CO_COMMFUNC_CPP_00028); //"禁怪区";
	case 6:
		return RES_STRING(CO_COMMFUNC_CPP_00029); //"矿区";
	default:
		return RES_STRING(CO_COMMFUNC_CPP_00030); //"未知";
	}
}
