...
public:
	...
	virtual void getColor(D3DXCOLOR* pSColor) { *pSColor = _dwColor; }
...
public:
	...
	void getFrameColor(int iIdx, D3DCOLOR* pSColor) { *pSColor = _vecFrameColor[iIdx]; }
	void getColor(D3DXCOLOR* pSColor) { *pSColor = _dwColor; }
