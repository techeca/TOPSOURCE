...
public:
	LW_RESULT Reserve(DWORD size) { return _heap.Reserve(size); }
	LW_RESULT Clear() { return _heap.Clear(); }
	LW_RESULT Push(const void* t) { return _heap.Push((T::value_type_ref)t); }
	LW_RESULT Push(const void* buf, DWORD size) { return _heap.Push((T::value_type_ptr)buf, size); }
	LW_RESULT Pop() { return _heap.Pop(); }
	LW_RESULT Top(void** t) { return _heap.Top(t); }
	LW_RESULT Find(DWORD* id, const void* t) { return _heap.Find(id, (T::value_type_ref)t); }
	LW_RESULT Update(DWORD id) { return _heap.Update(id); }
	LW_RESULT Remove(DWORD id) { return _heap.Remove(id); }

	void SetCompareProc(lwHeapCompProc proc) { _heap.SetCompareProc((T::lwHeapTCompareProc)proc); }
	void SetFilterProc(lwHeapFilterProc proc) { _heap.SetFilterProc((T::lwHeapTFilterProc)proc); }
	lwHeapCompProc GetCompareProc() { return (lwHeapCompProc)_heap.GetCompareProc(); }
	lwHeapFilterProc GetFilterProc() { return (lwHeapFilterProc)_heap.GetFilterProc(); }

	DWORD GetHeapNum() { return _heap.GetHeapNum(); }
	DWORD GetHeapCapacity() { return _heap.GetHeapCapacity(); }
	void* GetBuffer() { return _heap.GetBuffer(); }
