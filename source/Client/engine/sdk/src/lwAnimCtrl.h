...
public:
	...
	// == base method
	virtual LW_DWORD GetCtrlType() const { return lwAnimCtrl::_GetCtrlType(); }
	virtual void SetResFile(const lwResFileAnimData* info) { lwAnimCtrl::_SetResFile(info); }
	virtual lwResFileAnimData* GetResFileInfo() { return lwAnimCtrl::_GetResFileInfo(); }
	virtual LW_VOID SetRegisterID(LW_DWORD id) { lwAnimCtrl::_SetRegisterID(id); }
	virtual LW_DWORD GetRegisterID() const { return lwAnimCtrl::_GetRegisterID(); }
	virtual lwIPoseCtrl* GetPoseCtrl() { return lwAnimCtrl::_GetPoseCtrl(); }
	// end
...
public:
	...
	virtual lwIPoseCtrl* GetPoseCtrl() { return (lwIPoseCtrl*)&_pose_ctrl; }
