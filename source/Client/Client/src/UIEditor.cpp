...
bool CEditor::Init() {
	...
	if (!trvEditor)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "trvEditor");
	...
	if (!imgEditor)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "imgEditor");

	btnColor = dynamic_cast<CTextButton*>(frmEditor->Find("btnColor"));
	if (!btnColor)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "btnColor");
	...
	if (!chkSize01)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "chkSize01");

	chkSize02 = dynamic_cast<CCheckBox*>(frmEditor->Find("chkSize02"));
	if (!chkSize02)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "chkSize02");

	chkSize03 = dynamic_cast<CCheckBox*>(frmEditor->Find("chkSize03"));
	if (!chkSize03)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "chkSize03");

	chgGroup = dynamic_cast<CCheckGroup*>(frmEditor->Find("chgGroup"));
	if (!chgGroup)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "chgGroup");
	chgGroup->evtSelectChange = _CheckSelectChange;

	chkWireFrame = dynamic_cast<CCheckBox*>(frmEditor->Find("chkWireFrame"));
	if (!chkWireFrame)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "chkWireFrame");
	chkWireFrame->evtCheckChange = _WireCheckChange;

	chkEnabledAlpha = dynamic_cast<CCheckBox*>(frmEditor->Find("chkEnabledAlpha"));
	if (!chkEnabledAlpha)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "chkEnabledAlpha");
	...
	if (!chkSmooth)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "chkSmooth");
	...
	if (!chkHideTree)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "chkHideTree");
	...
	if (!imgTreeFrame)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "imgTreeFrame");

	edtSetMainChaPos = dynamic_cast<CEdit*>(frmEditor->Find("edtSetMainChaPos"));
	if (!edtSetMainChaPos)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "edtSetMainChaPos");
	...
	if (!edtSetBrushHeight)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "edtSetBrushHeight");
	...
	if (!chkModifyHeight)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "chkModifyHeight");
	...
	if (!chkColor)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "chkColor");
	...
	if (!chkShowLightBrush)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "chkShowLightBrush");
	...
	if (!ckhHideOptionEx)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "ckhHideOptionEx");
	...
	if (!imgEditorEx)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "imgEditorEx");

	lblSetMainChaPos = dynamic_cast<CLabel*>(frmEditor->Find("lblSetMainChaPos"));
	if (!lblSetMainChaPos)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "lblSetMainChaPos");

	lblSetBrushHeight = dynamic_cast<CLabel*>(frmEditor->Find("lblSetBrushHeight"));
	if (!lblSetBrushHeight)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "lblSetBrushHeight");

	ckhShowCompass = dynamic_cast<CCheckBox*>(frmEditor->Find("ckhShowCompass"));
	if (!ckhShowCompass)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "ckhShowCompass");
	...
	if (!lblSetIslandIndex)
		return Error(g_oLangRec.GetString(45), frmEditor->GetName(), "lblSetIslandIndex");
