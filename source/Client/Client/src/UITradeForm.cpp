...
bool CTradeMgr::Init() {
	...
	if (!grdSale)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "grdSale");
	...
	if (!grdBuy)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "grdBuy");
	...
	if (!labOtherGold)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "labOtherGold");

	labSelfGold = dynamic_cast<CLabelEx*>(frmPlayertrade->Find("labSelfGold"));
	if (!labSelfGold)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "labSelfGold");

	labOtherIMP = dynamic_cast<CLabelEx*>(frmPlayertrade->Find("labOtherIMP"));
	if (!labOtherIMP)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "labOtherIMP");

	labSelfIMP = dynamic_cast<CLabelEx*>(frmPlayertrade->Find("labSelfIMP"));
	if (!labSelfIMP)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "labSelfIMP");

	chkYes = (CCheckBox*)frmPlayertrade->Find("chkYes");
	if (!chkYes)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "chkYes");

	chkTrade = (CCheckBox*)frmPlayertrade->Find("chkTrade");
	if (!chkTrade)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "chkTrade");

	btnYes = (CTextButton*)frmPlayertrade->Find("btnYes");
	if (!btnYes)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "btnYes");

	btnTrade = (CTextButton*)frmPlayertrade->Find("btnTrade");
	if (!btnTrade)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "btnTrade");

	btnGold = (CTextButton*)frmPlayertrade->Find("btnGold");
	if (!btnGold)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "btnGold");

	btnIMP = (CTextButton*)frmPlayertrade->Find("btnIMP");
	if (!btnIMP)
		return Error(g_oLangRec.GetString(45), frmPlayertrade->GetName(), "btnIMP");
